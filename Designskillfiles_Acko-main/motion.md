---
description: Animation tokens — easing curves, keyframes, duration guidance, and performance rules
---
...
There are **no `--duration-*` tokens** in `tokens.css`. Use raw values directly:
...
Define these in the component CSS file that needs them:
