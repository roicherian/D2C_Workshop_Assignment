...
const HERO_FEATURES = [
  { icon: <HospitalCrossIcon />, text: 'Cashless treatment at 10,000+ hospitals' },
  { icon: <CoinsShieldIcon />, text: 'Cover up to ₹1 crore for your family' },
]
    ...
    <div className="health-insurance-landing">
      ...
      <div className="health-insurance-landing__container">
        ...
        <section className="health-insurance-landing__content">
          <Typography as="h2" variant="h2" className="health-insurance-landing__heading">
            HEALTH INSURANCE
          </Typography>
          <Typography variant="body" className="health-insurance-landing__body">
